...
public class BroadcastMessageListAdapter extends RecyclerView.Adapter {
    ...
    private List<FirestoreBroadcastChatModel> mMessageList;
    private OnItemClickListener mItemClickListener;

    public BroadcastMessageListAdapter(List<FirestoreBroadcastChatModel> messageList) {
    ...
    public int getItemViewType(int position) {
        FirestoreBroadcastChatModel message = (FirestoreBroadcastChatModel) mMessageList.get(position);
    ...
    private static class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(FirestoreBroadcastChatModel message) {
    ...
    private static class MyImageFileMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(FirestoreBroadcastChatModel message, OnItemClickListener mItemClickListener) {
    ...
    public interface OnItemClickListener {
        ...
        void onImageMessageItemClick(FirestoreBroadcastChatModel message);

        void onAudioMessageItemClick(FirestoreBroadcastChatModel message);

        void onVideoMessageItemClick(FirestoreBroadcastChatModel message);
