...
public class OtpView extends LinearLayout{
    ...
    private void init(AttributeSet attrs) {
        ...
        // continue_btn = findViewById(R.id.otpContinue);
        enableKeypad();
    ...
    private void styleEditTexts(TypedArray styles) {
        int textColor = styles.getColor(R.styleable.OtpView_android_textColor, Color.BLUE);
        styles.getColor(R.styleable.OtpView_text_background_color, Color.BLUE);
    ...
    private void setOnTextChangeListener() {
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (mCurrentlyFocusedEditText.getText() != null) {
