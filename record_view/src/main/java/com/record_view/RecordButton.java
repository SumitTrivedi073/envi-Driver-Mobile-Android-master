...
public class RecordButton extends AppCompatImageView implements View.OnTouchListener, View.OnClickListener {
    ...
    private com.record_view.ScaleAnim scaleAnim;
    private com.record_view.RecordView recordView;
    private boolean listenForRecord = true;
    private com.record_view.OnRecordClickListener onRecordClickListener;
    private com.record_view.OnRecordClickListener sendClickListener;
    private boolean isInLockMode = false;
    private Drawable micIcon, sendIcon;

    public void setRecordView(com.record_view.RecordView recordView) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        scaleAnim = new com.record_view.ScaleAnim(this);
    ...
    public void setOnRecordClickListener(com.record_view.OnRecordClickListener onRecordClickListener) {
        this.onRecordClickListener = onRecordClickListener;
    }

    protected void setSendClickListener(com.record_view.OnRecordClickListener sendClickListener) {
