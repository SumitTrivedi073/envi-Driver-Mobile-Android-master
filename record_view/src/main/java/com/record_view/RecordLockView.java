...
public class RecordLockView extends View {
    ...
    private com.record_view.RecordLockViewListener recordLockViewListener;
    ...
    protected void setRecordLockViewListener(com.record_view.RecordLockViewListener recordLockViewListener) {
