...
public class RecordView extends RelativeLayout implements com.record_view.RecordLockViewListener {
    ...
    private com.record_view.OnRecordListener recordListener;
    private com.record_view.RecordPermissionHandler recordPermissionHandler;
    ...
    private com.record_view.AnimationHelper animationHelper;
    ...
    private com.record_view.RecordLockView recordLockView;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        animationHelper = new com.record_view.AnimationHelper(context, basketImg, smallBlinkingMic, isRecordButtonGrowingAnimationEnabled);
    ...
    public void setOnRecordListener(com.record_view.OnRecordListener recrodListener) {
        this.recordListener = recrodListener;
    }

    public void setRecordPermissionHandler(com.record_view.RecordPermissionHandler recordPermissionHandler) {
        this.recordPermissionHandler = recordPermissionHandler;
    }

    public void setOnBasketAnimationEndListener(com.record_view.OnBasketAnimationEnd onBasketAnimationEndListener) {
    ...
    public void setRecordLockImageView(com.record_view.RecordLockView recordLockView) {
